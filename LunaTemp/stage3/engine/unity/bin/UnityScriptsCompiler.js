...
Bridge.assembly("UnityScriptsCompiler", function ($asm, globals) {
    ...
    Bridge.define("AudioController", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "AudioController#init", this ); }
...
if ( TRACE ) { TRACE( "AudioController#CreateNewSource", this ); }
                ...
                s.transform.parent = this.pool;
                return s;
            },
            /*AudioController.CreateNewSource end.*/

            /*AudioController.PlayMusic start.*/
            PlayMusic: function () {
if ( TRACE ) { TRACE( "AudioController#PlayMusic", this ); }

                this.musicSource.clip = this.BGM;
                this.musicSource.loop = true;
                this.musicSource.Play();
            },
            /*AudioController.PlayMusic end.*/

            /*AudioController.Shoot start.*/
            Shoot: function () {
if ( TRACE ) { TRACE( "AudioController#Shoot", this ); }

                this.PlaySFX(this.shootSFX);
            },
            /*AudioController.Shoot end.*/

            /*AudioController.Hit start.*/
            Hit: function () {
if ( TRACE ) { TRACE( "AudioController#Hit", this ); }

                this.PlaySFX(this.hitSFX);
            },
            /*AudioController.Hit end.*/
...
if ( TRACE ) { TRACE( "BulletController#Update", this ); }
                ...
                this.transform.position = this.transform.position.$clone().add( this.direction.clone().scale( this.speed ).clone().scale( UnityEngine.Time.deltaTime ) );
            },
            /*BulletController.Update end.*/

            /*BulletController.InitBullet start.*/
            InitBullet: function (pos, dir, speed) {
if ( TRACE ) { TRACE( "BulletController#InitBullet", this ); }

                this.transform.position = pos.$clone();
                this.direction = dir.clone().normalize().$clone();
                this.speed = speed;
            },
            /*BulletController.InitBullet end.*/
...
if ( TRACE ) { TRACE( "GameController#Start", this ); }
                ...
                this.StartCoroutine$1(this.Demo());
            },
...
if ( TRACE ) { TRACE( "GameController#Win", this ); }
            ...
            /*GameController.CountShoot start.*/
            CountShoot: function () {
if ( TRACE ) { TRACE( "GameController#CountShoot", this ); }

                this.count = (this.count + 1) | 0;
                this.currentShootText.text = Bridge.toString(this.count);
                this.StartCoroutine$1(this.CheckResult());
            },
            /*GameController.CountShoot end.*/

            /*GameController.CheckResult start.*/
            CheckResult: function () {
if ( TRACE ) { TRACE( "GameController#CheckResult", this ); }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    if (this.count >= this.MaxShoot && !this.isWin) {
                                            this.lossScene.SetActive(true);
                                            !Bridge.staticEquals(this.OnEnd, null) ? this.OnEnd() : null;
                                        }
            ...
            /*GameController.CheckResult end.*/

            /*GameController.Demo start.*/
            Demo: function () {
if ( TRACE ) { TRACE( "GameController#Demo", this ); }
...
if ( TRACE ) { TRACE( "LunaController#Start", this ); }
                ...
                this.StartCoroutine$1(this.End());
                GameController.Ins.OnEnd = Bridge.fn.combine(GameController.Ins.OnEnd, Bridge.fn.cacheBind(this, this.ShowEndCard));
            },
            /*LunaController.Start end.*/

            /*LunaController.ShowEndCard start.*/
            ShowEndCard: function () {
if ( TRACE ) { TRACE( "LunaController#ShowEndCard", this ); }

                this.endCard.gameObject.SetActive(true);
            },
            /*LunaController.ShowEndCard end.*/
...
if ( TRACE ) { TRACE( "LunaController#ClickCTA", this ); }
            ...
            /*LunaController.End start.*/
            End: function () {
if ( TRACE ) { TRACE( "LunaController#End", this ); }
...
if ( TRACE ) { TRACE( "PlayerController#init", this ); }
                ...
                this.startAngle = new UnityEngine.Vector3();
                this.oldAngle = new UnityEngine.Vector3();
                this.startMousePos = new UnityEngine.Vector2();
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "PlayerController#Start", this ); }
                ...
                this.bulletPool = new (System.Collections.Generic.Queue$1(BulletController)).ctor();
                this.hitVFXPool = new (System.Collections.Generic.Queue$1(UnityEngine.GameObject)).ctor();
                this.oldAngle = this.startAngle.$clone();
                this.shootBtn.onClick.AddListener(Bridge.fn.cacheBind(this, this.Shoot));
            },
...
if ( TRACE ) { TRACE( "PlayerController#Update", this ); }
            ...
            /*PlayerController.Rotate start.*/
            Rotate: function () {
if ( TRACE ) { TRACE( "PlayerController#Rotate", this ); }

                if (UnityEngine.Input.touchCount <= 0) {
                    return;
                }
                var touch = UnityEngine.Input.GetTouch(0);
                if (UnityEngine.EventSystems.EventSystem.current.IsPointerOverGameObject$1(touch.fingerId)) {
                ...
                if (UnityEngine.Input.GetMouseButtonDown(0)) {
                    this.startMousePos = UnityEngine.Vector2.FromVector3(UnityEngine.Input.mousePosition.$clone());
                }
                if (UnityEngine.Input.GetMouseButton(0)) {
                    var currentMousePos = UnityEngine.Vector2.FromVector3(UnityEngine.Input.mousePosition.$clone());
                    var dir = currentMousePos.$clone().sub( this.startMousePos );
                    var angle = UnityEngine.Vector3.FromVector2(new pc.Vec2( this.rotateSpeed * -dir.y, this.rotateSpeed * dir.x ));
                    var currentAngle = new pc.Vec3( Math.abs(angle.x + this.oldAngle.x - this.startAngle.x) < this.maxRotateAngleX ? angle.x + this.oldAngle.x : this.oldAngle.x, Math.abs(angle.y + this.oldAngle.y - this.startAngle.y) < this.maxRotateAngleY ? angle.y + this.oldAngle.y : this.oldAngle.y, this.oldAngle.z );

                    var q = this.player.rotation.$clone();
                    q.setFromEulerAngles_Unity( currentAngle.$clone().x, currentAngle.$clone().y, currentAngle.$clone().z );
                    this.player.rotation = q.$clone();
                    this.oldAngle = currentAngle.$clone();
                    this.startMousePos = currentMousePos.$clone();
                }
            },
            /*PlayerController.Rotate end.*/
...
if ( TRACE ) { TRACE( "PlayerController#Shoot", this ); }
                ...
                this.shootVFX.Play();
                this.SpawnBullet();
                DG.Tweening.TweenSettingsExtensions.SetLoops$1(DG.Tweening.Core.TweenerCore$3(UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions), DG.Tweening.ShortcutExtensions.DORotate(this.transform, this.oldAngle.$clone().add( new pc.Vec3( -2, 0, 0 ) ), 0.1), 2, DG.Tweening.LoopType.Yoyo);
                this.StartCoroutine$1(this.CD());
                var hit = { v : new UnityEngine.RaycastHit() };
                if (UnityEngine.Physics.Raycast$3(this.point1.position, (this.point2.position.$clone().sub( this.point1.position )).clone().normalize(), hit, 300.0)) {
                    if (UnityEngine.Object.op_Implicit(hit.v.collider)) {
                        this.Hit(hit.v.point, hit.v.collider.CompareTag("Point"));
                    }
                }
            },
...
if ( TRACE ) { TRACE( "PlayerController#SpawnBullet", this ); }
                ...
                bullet.InitBullet(this.point2.position, this.point2.position.$clone().sub( this.point1.position ), this.bulletSpeed);
                this.StartCoroutine$1(this.ReturnBulletPool(bullet));
            },
...
if ( TRACE ) { TRACE( "PlayerController#CreateNewBullet", this ); }
                ...
                return UnityEngine.Object.Instantiate(BulletController, this.bulletPrefab);
            },
            /*PlayerController.CreateNewBullet end.*/

            /*PlayerController.SpawnHitVFX start.*/
            SpawnHitVFX: function (pos) {
if ( TRACE ) { TRACE( "PlayerController#SpawnHitVFX", this ); }

                var hit;
                if (this.hitVFXPool.Count > 0) {
                    hit = this.hitVFXPool.Dequeue();
                    hit.transform.position = pos.$clone();
                    hit.SetActive(true);
                } else {
                    hit = this.CreateNewHitVFX();
                    hit.transform.position = pos.$clone();
                }
                this.StartCoroutine$1(this.ReturnHitVFXPool(hit));
            },
            /*PlayerController.SpawnHitVFX end.*/

            /*PlayerController.CreateNewHitVFX start.*/
            CreateNewHitVFX: function () {
if ( TRACE ) { TRACE( "PlayerController#CreateNewHitVFX", this ); }

                return UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.hitVFXPrefab);
            },
            /*PlayerController.CreateNewHitVFX end.*/

            /*PlayerController.ReturnBulletPool start.*/
            ReturnBulletPool: function (bullet) {
if ( TRACE ) { TRACE( "PlayerController#ReturnBulletPool", this ); }
            ...
            /*PlayerController.ReturnBulletPool end.*/

            /*PlayerController.Hit start.*/
            Hit: function (pos, hitPoint) {
if ( TRACE ) { TRACE( "PlayerController#Hit", this ); }

                this.SpawnHitVFX(pos);
                AudioController.Ins.Hit();
                if (hitPoint) {
                    GameController.Ins.Win();
                }
            },
            /*PlayerController.Hit end.*/

            /*PlayerController.ReturnHitVFXPool start.*/
            ReturnHitVFXPool: function (hit) {
if ( TRACE ) { TRACE( "PlayerController#ReturnHitVFXPool", this ); }
            ...
            /*PlayerController.ReturnHitVFXPool end.*/

            /*PlayerController.CD start.*/
            CD: function () {
if ( TRACE ) { TRACE( "PlayerController#CD", this ); }
            ...
            /*PlayerController.CD end.*/

            /*PlayerController.OnDrawGizmosSelected start.*/
            OnDrawGizmosSelected: function () {
if ( TRACE ) { TRACE( "PlayerController#OnDrawGizmosSelected", this ); }

                pc.stubProxy.reportMethod( 'UnityEngine.Gizmos.DrawRay', null );
            },
            /*PlayerController.OnDrawGizmosSelected end.*/
    ...
    /*AudioController start.*/
    $m("AudioController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"BootstrapPool","t":8,"sn":"BootstrapPool","rt":$n[0].Void},{"a":1,"n":"CreateIns","t":8,"sn":"CreateIns","rt":$n[0].Void},{"a":1,"n":"CreateNewSource","t":8,"sn":"CreateNewSource","rt":$n[1].AudioSource},{"a":1,"n":"GetFreeSource","t":8,"sn":"GetFreeSource","rt":$n[1].AudioSource},{"a":2,"n":"Hit","t":8,"sn":"Hit","rt":$n[0].Void},{"a":1,"n":"PlayMusic","t":8,"sn":"PlayMusic","rt":$n[0].Void},{"a":1,"n":"PlaySFX","t":8,"pi":[{"n":"clip","pt":$n[1].AudioClip,"ps":0}],"sn":"PlaySFX","rt":$n[0].Void,"p":[$n[1].AudioClip]},{"a":2,"n":"Shoot","t":8,"sn":"Shoot","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"Ins","is":true,"t":16,"rt":AudioController,"g":{"a":2,"n":"get_Ins","t":8,"rt":AudioController,"fg":"Ins","is":true},"s":{"a":1,"n":"set_Ins","t":8,"p":[AudioController],"rt":$n[0].Void,"fs":"Ins","is":true},"fn":"Ins"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"BGM","t":4,"rt":$n[1].AudioClip,"sn":"BGM"},{"a":1,"n":"SFXPool","t":4,"rt":$n[2].Queue$1(UnityEngine.AudioSource),"sn":"SFXPool"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"hitSFX","t":4,"rt":$n[1].AudioClip,"sn":"hitSFX"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"musicSource","t":4,"rt":$n[1].AudioSource,"sn":"musicSource"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"pool","t":4,"rt":$n[1].Transform,"sn":"pool"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"shootSFX","t":4,"rt":$n[1].AudioClip,"sn":"shootSFX"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"startSize","t":4,"rt":$n[0].Int32,"sn":"startSize","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"backing":true,"n":"<Ins>k__BackingField","is":true,"t":4,"rt":AudioController,"sn":"Ins"}]}; }, $n);
    /*AudioController end.*/

    /*BulletController start.*/
    $m("BulletController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"InitBullet","t":8,"pi":[{"n":"pos","pt":$n[1].Vector3,"ps":0},{"n":"dir","pt":$n[1].Vector3,"ps":1},{"n":"speed","pt":$n[0].Single,"ps":2}],"sn":"InitBullet","rt":$n[0].Void,"p":[$n[1].Vector3,$n[1].Vector3,$n[0].Single]},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"direction","t":4,"rt":$n[1].Vector3,"sn":"direction"},{"a":1,"n":"speed","t":4,"rt":$n[0].Single,"sn":"speed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*BulletController end.*/

    /*GameController start.*/
    $m("GameController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"CheckResult","t":8,"sn":"CheckResult","rt":$n[3].IEnumerator},{"a":2,"n":"CountShoot","t":8,"sn":"CountShoot","rt":$n[0].Void},{"a":1,"n":"CreateIns","t":8,"sn":"CreateIns","rt":$n[0].Void},{"a":1,"n":"Demo","t":8,"sn":"Demo","rt":$n[3].IEnumerator},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"Win","t":8,"sn":"Win","rt":$n[0].Void},{"a":2,"n":"Ins","is":true,"t":16,"rt":GameController,"g":{"a":2,"n":"get_Ins","t":8,"rt":GameController,"fg":"Ins","is":true},"s":{"a":1,"n":"set_Ins","t":8,"p":[GameController],"rt":$n[0].Void,"fs":"Ins","is":true},"fn":"Ins"},{"at":[new UnityEngine.LunaPlaygroundFieldAttribute("Max Shoot", -1, null, false, null)],"a":2,"n":"MaxShoot","t":4,"rt":$n[0].Int32,"sn":"MaxShoot","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"OnEnd","t":4,"rt":Function,"sn":"OnEnd"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"UI","t":4,"rt":$n[1].GameObject,"sn":"UI"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"camera0","t":4,"rt":$n[1].GameObject,"sn":"camera0"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"camera1","t":4,"rt":$n[1].GameObject,"sn":"camera1"},{"a":1,"n":"count","t":4,"rt":$n[0].Int32,"sn":"count","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"currentShootText","t":4,"rt":$n[4].Text,"sn":"currentShootText"},{"a":1,"n":"isWin","t":4,"rt":$n[0].Boolean,"sn":"isWin","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"lossScene","t":4,"rt":$n[1].GameObject,"sn":"lossScene"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"mainCamera","t":4,"rt":$n[1].GameObject,"sn":"mainCamera"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"panel","t":4,"rt":$n[1].GameObject,"sn":"panel"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"winScene","t":4,"rt":$n[1].GameObject,"sn":"winScene"},{"a":1,"backing":true,"n":"<Ins>k__BackingField","is":true,"t":4,"rt":GameController,"sn":"Ins"}]}; }, $n);
    /*GameController end.*/

    /*LunaController start.*/
    $m("LunaController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"ClickCTA","t":8,"sn":"ClickCTA","rt":$n[0].Void},{"a":1,"n":"End","t":8,"sn":"End","rt":$n[3].IEnumerator},{"a":1,"n":"ShowEndCard","t":8,"sn":"ShowEndCard","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"at":[new UnityEngine.LunaPlaygroundFieldAttribute("Time Play", -1, null, false, null)],"a":2,"n":"TimePlay","t":4,"rt":$n[0].Single,"sn":"TimePlay","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"endCard","t":4,"rt":$n[4].Button,"sn":"endCard"}]}; }, $n);
    /*LunaController end.*/

    /*PlayerController start.*/
    $m("PlayerController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"CD","t":8,"sn":"CD","rt":$n[3].IEnumerator},{"a":1,"n":"CreateNewBullet","t":8,"sn":"CreateNewBullet","rt":BulletController},{"a":1,"n":"CreateNewHitVFX","t":8,"sn":"CreateNewHitVFX","rt":$n[1].GameObject},{"a":1,"n":"Hit","t":8,"pi":[{"n":"pos","pt":$n[1].Vector3,"ps":0},{"n":"hitPoint","pt":$n[0].Boolean,"ps":1}],"sn":"Hit","rt":$n[0].Void,"p":[$n[1].Vector3,$n[0].Boolean]},{"a":1,"n":"OnDrawGizmosSelected","t":8,"sn":"OnDrawGizmosSelected","rt":$n[0].Void},{"a":1,"n":"ReturnBulletPool","t":8,"pi":[{"n":"bullet","pt":BulletController,"ps":0}],"sn":"ReturnBulletPool","rt":$n[3].IEnumerator,"p":[BulletController]},{"a":1,"n":"ReturnHitVFXPool","t":8,"pi":[{"n":"hit","pt":$n[1].GameObject,"ps":0}],"sn":"ReturnHitVFXPool","rt":$n[3].IEnumerator,"p":[$n[1].GameObject]},{"a":1,"n":"Rotate","t":8,"sn":"Rotate","rt":$n[0].Void},{"a":1,"n":"Shoot","t":8,"sn":"Shoot","rt":$n[0].Void},{"a":1,"n":"SpawnBullet","t":8,"sn":"SpawnBullet","rt":$n[0].Void},{"a":1,"n":"SpawnHitVFX","t":8,"pi":[{"n":"pos","pt":$n[1].Vector3,"ps":0}],"sn":"SpawnHitVFX","rt":$n[0].Void,"p":[$n[1].Vector3]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"bulletPool","t":4,"rt":$n[2].Queue$1(BulletController),"sn":"bulletPool"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"bulletPrefab","t":4,"rt":BulletController,"sn":"bulletPrefab"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"bulletSpeed","t":4,"rt":$n[0].Single,"sn":"bulletSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"hitVFXPool","t":4,"rt":$n[2].Queue$1(UnityEngine.GameObject),"sn":"hitVFXPool"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"hitVFXPrefab","t":4,"rt":$n[1].GameObject,"sn":"hitVFXPrefab"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"maxRotateAngleX","t":4,"rt":$n[0].Single,"sn":"maxRotateAngleX","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"maxRotateAngleY","t":4,"rt":$n[0].Single,"sn":"maxRotateAngleY","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"oldAngle","t":4,"rt":$n[1].Vector3,"sn":"oldAngle"},{"a":1,"n":"onCD","t":4,"rt":$n[0].Boolean,"sn":"onCD","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"player","t":4,"rt":$n[1].Transform,"sn":"player"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"point1","t":4,"rt":$n[1].Transform,"sn":"point1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"point2","t":4,"rt":$n[1].Transform,"sn":"point2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"rotateSpeed","t":4,"rt":$n[0].Single,"sn":"rotateSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"shootBtn","t":4,"rt":$n[4].Button,"sn":"shootBtn"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"shootVFX","t":4,"rt":$n[1].ParticleSystem,"sn":"shootVFX"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"startAngle","t":4,"rt":$n[1].Vector3,"sn":"startAngle"},{"a":1,"n":"startMousePos","t":4,"rt":$n[1].Vector2,"sn":"startMousePos"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"tut","t":4,"rt":$n[1].GameObject,"sn":"tut"}]}; }, $n);
    /*PlayerController end.*/
