...
if ( TRACE ) { TRACE( "LayoutController#Fit", this ); }
                ...
                if (ratio < 1) {
                    this.optionV.transform.localScale = new pc.Vec3( 1, 1, 1 ).clone().scale( 0.5 );
                    this.optionH.transform.localScale = pc.Vec3.ZERO.clone();
                    return;
                }
                if (ratio < 1.5) {
                    this.optionH.transform.localScale = new pc.Vec3( 1, 1, 1 ).clone().scale( 0.65 );
                } else {
                    this.optionH.transform.localScale = new pc.Vec3( 1, 1, 1 );
                }
                this.optionV.transform.localScale = pc.Vec3.ZERO.clone();
            },
...
if ( TRACE ) { TRACE( "TutController#Start", this ); }
                ...
                for (var i = 1; i < count; i = (i + 1) | 0) {
                    var index = { v : i };
                    DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.AppendCallback(DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.AppendCallback(this.sequence, (function ($me, index) {
                        return Bridge.fn.bind($me, function () {
                            if (!UnityEngine.Object.op_Implicit(this.options.getItem(((index.v - 1) | 0)).$clone().Demo)) {
                                return;
                            }
                            DG.Tweening.ShortcutExtensions.DOScale(this.options.getItem(((index.v - 1) | 0)).$clone().Demo, 1.1, this.scaleTime);
                        });
                    })(this, index)), DG.Tweening.ShortcutExtensions.DOScale(this.transform, this.toScale, this.scaleTime)), (function ($me, index) {
                        return Bridge.fn.bind($me, function () {
                            if (!UnityEngine.Object.op_Implicit(this.options.getItem(((index.v - 1) | 0)).$clone().Demo)) {
                                return;
                            }
                            DG.Tweening.ShortcutExtensions.DOScale(this.options.getItem(((index.v - 1) | 0)).$clone().Demo, 1.0, this.scaleTime);
                        });
                    })(this, index)), DG.Tweening.ShortcutExtensions.DOScale(this.transform, this.fromScale, this.scaleTime)), DG.Tweening.ShortcutExtensions.DOLocalMove(this.transform, this.options.getItem(index.v).$clone().Position.$clone(), this.moveTime));
                }
                DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.AppendCallback(DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.AppendCallback(this.sequence, Bridge.fn.bind(this, function () {
                    if (!UnityEngine.Object.op_Implicit(this.options.getItem(((count - 1) | 0)).$clone().Demo)) {
                        return;
                    }
                    DG.Tweening.ShortcutExtensions.DOScale(this.options.getItem(((count - 1) | 0)).$clone().Demo, 1.1, this.scaleTime);
                })), DG.Tweening.ShortcutExtensions.DOScale(this.transform, this.toScale, this.scaleTime)), Bridge.fn.bind(this, function () {
                    if (!UnityEngine.Object.op_Implicit(this.options.getItem(((count - 1) | 0)).$clone().Demo)) {
                        return;
                    }
                    DG.Tweening.ShortcutExtensions.DOScale(this.options.getItem(((count - 1) | 0)).$clone().Demo, 1.0, this.scaleTime);
                })), DG.Tweening.ShortcutExtensions.DOScale(this.transform, this.fromScale, this.scaleTime)), DG.Tweening.ShortcutExtensions.DOLocalMove(this.transform, this.options.getItem(0).$clone().Position.$clone(), this.moveTime));
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","UnityEngine","System.Collections","UnityEngine.UI","System.Collections.Generic","DG.Tweening","DG.Tweening.Core","System.Globalization","DG.Tweening.Plugins.Core.PathCore","DG.Tweening.Plugins.Options"];

    /*LayoutController start.*/
    $m("LayoutController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Fit","t":8,"sn":"Fit","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"oldRatio","t":4,"rt":$n[0].Single,"sn":"oldRatio","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"optionH","t":4,"rt":$n[1].Transform,"sn":"optionH"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"optionV","t":4,"rt":$n[1].Transform,"sn":"optionV"}]}; }, $n);
    /*LayoutController end.*/
    ...
    /*Option start.*/
    $m("Option", function () { return {"att":1057033,"a":2,"at":[new System.SerializableAttribute()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Demo","t":4,"rt":$n[1].RectTransform,"sn":"Demo"},{"a":2,"n":"Position","t":4,"rt":$n[1].Vector3,"sn":"Position"}]}; }, $n);
    /*Option end.*/
