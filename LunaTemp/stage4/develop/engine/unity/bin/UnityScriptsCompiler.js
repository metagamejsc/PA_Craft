...
if ( TRACE ) { TRACE( "GameController#init", this ); }
                ...
                this.selectedColor = new UnityEngine.Color();
                this.currentItem = new ItemOption();
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "GameController#Awake", this ); }
            ...
            /*GameController.InitModelOption start.*/
            InitModelOption: function () {
if ( TRACE ) { TRACE( "GameController#InitModelOption", this ); }

                this.models.ForEach(Bridge.fn.bind(this, function (m) {
                    m.Button.onClick.AddListener(Bridge.fn.bind(this, function () {
                        AudioController.Ins.PlaySFX(this.click1);
                        this.phase1.SetActive(false);
                        this.phase2.SetActive(true);
                        m.Model.SetActive(true);
                    }));
                }));
            },
            /*GameController.InitModelOption end.*/

            /*GameController.InitItemOption start.*/
            InitItemOption: function () {
if ( TRACE ) { TRACE( "GameController#InitItemOption", this ); }

                this.items.ForEach(Bridge.fn.bind(this, function (i) {
                    i.Button.onClick.AddListener(Bridge.fn.bind(this, function () {
                        if (UnityEngine.Object.op_Implicit(this.tut2)) {
                            UnityEngine.MonoBehaviour.Destroy(this.tut2);
                        }
                        AudioController.Ins.PlaySFX(this.click2);
                        if (UnityEngine.Object.op_Implicit(this.currentItem.Item)) {
                            this.currentItem.Item.SetActive(false);
                            this.currentItem.BG.color = this.defaultColor.$clone();
                        }
                        this.currentItem = i.$clone();
                        this.currentItem.Item.SetActive(true);
                        this.currentItem.BG.color = this.selectedColor.$clone();
                    }));
                }));
            },
            /*GameController.InitItemOption end.*/
    ...
    /*ItemOption start.*/
    Bridge.define("ItemOption", {
        $kind: 4,
        statics: {
            methods: {
                getDefaultValue: function () {
if ( TRACE ) { TRACE( "ItemOption#getDefaultValue", this ); }
 return new ItemOption(); }
        ...
        ctors: {
            ctor: function () {
if ( TRACE ) { TRACE( "ItemOption#ctor", this ); }
...
if ( TRACE ) { TRACE( "ItemOption#getHashCode", this ); }

                var h = Bridge.addHash([3604632327, this.Button, this.Item, this.BG]);
                return h;
            },
            equals: function (o) {
if ( TRACE ) { TRACE( "ItemOption#equals", this ); }

                if (!Bridge.is(o, ItemOption)) {
                    return false;
                }
                return Bridge.equals(this.Button, o.Button) && Bridge.equals(this.Item, o.Item) && Bridge.equals(this.BG, o.BG);
            },
            $clone: function (to) {
if ( TRACE ) { TRACE( "ItemOption#$clone", this ); }

                var s = to || new ItemOption();
...
if ( TRACE ) { TRACE( "LunaController#Awake", this ); }
                ...
                this.CTA.onClick.AddListener(Bridge.fn.cacheBind(this, this.ClickCTA));
...
if ( TRACE ) { TRACE( "LunaController#EndGame", this ); }
    ...
    /*ModelOption start.*/
    Bridge.define("ModelOption", {
        $kind: 4,
        statics: {
            methods: {
                getDefaultValue: function () {
if ( TRACE ) { TRACE( "ModelOption#getDefaultValue", this ); }
 return new ModelOption(); }
        ...
        ctors: {
            ctor: function () {
if ( TRACE ) { TRACE( "ModelOption#ctor", this ); }
        ...
        methods: {
            getHashCode: function () {
if ( TRACE ) { TRACE( "ModelOption#getHashCode", this ); }

                var h = Bridge.addHash([3661835810, this.Button, this.Model]);
                return h;
            },
            equals: function (o) {
if ( TRACE ) { TRACE( "ModelOption#equals", this ); }

                if (!Bridge.is(o, ModelOption)) {
                    return false;
                }
                return Bridge.equals(this.Button, o.Button) && Bridge.equals(this.Model, o.Model);
            },
            $clone: function (to) {
if ( TRACE ) { TRACE( "ModelOption#$clone", this ); }

                var s = to || new ModelOption();
                s.Button = this.Button;
                s.Model = this.Model;
                return s;
            }
...
if ( TRACE ) { TRACE( "TutController#init", this ); }
                ...
                this.posL = new UnityEngine.Vector3();
                this.posR = new UnityEngine.Vector3();
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "TutController#Start", this ); }
                ...
                DG.Tweening.TweenSettingsExtensions.SetLoops$1(DG.Tweening.Sequence, DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.AppendCallback(DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.AppendCallback(DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.AppendCallback(DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.AppendCallback(this.sequence, Bridge.fn.bind(this, function () {
                    DG.Tweening.ShortcutExtensions.DOScale(this.optionL, 0.8, this.scaleTime);
                })), DG.Tweening.ShortcutExtensions.DOScale(this.transform, this.toScale, this.scaleTime)), Bridge.fn.bind(this, function () {
                    DG.Tweening.ShortcutExtensions.DOScale(this.optionL, 0.75, this.scaleTime);
                })), DG.Tweening.ShortcutExtensions.DOScale(this.transform, this.fromScale, this.scaleTime)), DG.Tweening.ShortcutExtensions.DOLocalMove(this.transform, this.posR.$clone(), this.moveTime)), Bridge.fn.bind(this, function () {
                    DG.Tweening.ShortcutExtensions.DOScale(this.optionR, 0.8, this.scaleTime);
                })), DG.Tweening.ShortcutExtensions.DOScale(this.transform, this.toScale, this.scaleTime)), Bridge.fn.bind(this, function () {
                    DG.Tweening.ShortcutExtensions.DOScale(this.optionR, 0.75, this.scaleTime);
                })), DG.Tweening.ShortcutExtensions.DOScale(this.transform, this.fromScale, this.scaleTime)), DG.Tweening.ShortcutExtensions.DOLocalMove(this.transform, this.posL.$clone(), this.moveTime)), -1, DG.Tweening.LoopType.Restart);
            },
    ...
    /*AudioController start.*/
    $m("AudioController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"BootstrapPool","t":8,"sn":"BootstrapPool","rt":$n[0].Void},{"a":1,"n":"CreateIns","t":8,"sn":"CreateIns","rt":$n[0].Void},{"a":1,"n":"CreateNewSource","t":8,"sn":"CreateNewSource","rt":$n[1].AudioSource},{"a":1,"n":"GetFreeSource","t":8,"sn":"GetFreeSource","rt":$n[1].AudioSource},{"a":2,"n":"PlaySFX","t":8,"pi":[{"n":"clip","pt":$n[1].AudioClip,"ps":0}],"sn":"PlaySFX","rt":$n[0].Void,"p":[$n[1].AudioClip]},{"a":1,"n":"ReturnToPool","t":8,"pi":[{"n":"s","pt":$n[1].AudioSource,"ps":0}],"sn":"ReturnToPool","rt":$n[2].IEnumerator,"p":[$n[1].AudioSource]},{"a":2,"n":"Ins","is":true,"t":16,"rt":AudioController,"g":{"a":2,"n":"get_Ins","t":8,"rt":AudioController,"fg":"Ins","is":true},"s":{"a":1,"n":"set_Ins","t":8,"p":[AudioController],"rt":$n[0].Void,"fs":"Ins","is":true},"fn":"Ins"},{"a":1,"n":"SFXPool","t":4,"rt":$n[3].Queue$1(UnityEngine.AudioSource),"sn":"SFXPool"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"poolParent","t":4,"rt":$n[1].Transform,"sn":"poolParent"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"startSize","t":4,"rt":$n[0].Int32,"sn":"startSize","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"backing":true,"n":"<Ins>k__BackingField","is":true,"t":4,"rt":AudioController,"sn":"Ins"}]}; }, $n);
    /*AudioController end.*/

    /*GameController start.*/
    $m("GameController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"InitItemOption","t":8,"sn":"InitItemOption","rt":$n[0].Void},{"a":1,"n":"InitModelOption","t":8,"sn":"InitModelOption","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"click1","t":4,"rt":$n[1].AudioClip,"sn":"click1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"click2","t":4,"rt":$n[1].AudioClip,"sn":"click2"},{"a":1,"n":"currentItem","t":4,"rt":ItemOption,"sn":"currentItem"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"defaultColor","t":4,"rt":$n[1].Color,"sn":"defaultColor"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"items","t":4,"rt":$n[3].List$1(ItemOption),"sn":"items"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"models","t":4,"rt":$n[3].List$1(ModelOption),"sn":"models"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"phase1","t":4,"rt":$n[1].GameObject,"sn":"phase1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"phase2","t":4,"rt":$n[1].GameObject,"sn":"phase2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"selectedColor","t":4,"rt":$n[1].Color,"sn":"selectedColor"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"tut2","t":4,"rt":$n[1].GameObject,"sn":"tut2"}]}; }, $n);
    /*GameController end.*/

    /*ModelOption start.*/
    $m("ModelOption", function () { return {"att":1057033,"a":2,"at":[new System.SerializableAttribute()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Button","t":4,"rt":$n[4].Button,"sn":"Button"},{"a":2,"n":"Model","t":4,"rt":$n[1].GameObject,"sn":"Model"}]}; }, $n);
    /*ModelOption end.*/

    /*ItemOption start.*/
    $m("ItemOption", function () { return {"att":1057033,"a":2,"at":[new System.SerializableAttribute()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"BG","t":4,"rt":$n[4].Image,"sn":"BG"},{"a":2,"n":"Button","t":4,"rt":$n[4].Button,"sn":"Button"},{"a":2,"n":"Item","t":4,"rt":$n[1].GameObject,"sn":"Item"}]}; }, $n);
    /*ItemOption end.*/

    /*LunaController start.*/
    $m("LunaController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"ClickCTA","t":8,"sn":"ClickCTA","rt":$n[0].Void},{"a":1,"n":"EndGame","t":8,"sn":"EndGame","rt":$n[2].IEnumerator},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"at":[new UnityEngine.LunaPlaygroundAssetAttribute("BGM", 0, null)],"a":2,"n":"BGM","t":4,"rt":$n[1].AudioClip,"sn":"BGM"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"CTA","t":4,"rt":$n[4].Button,"sn":"CTA"},{"at":[new UnityEngine.LunaPlaygroundFieldAttribute("Limit Time Play?", -1, null, false, null)],"a":2,"n":"LimitTimePlay","t":4,"rt":$n[0].Boolean,"sn":"LimitTimePlay","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.LunaPlaygroundFieldAttribute("Time Play", -1, null, false, null)],"a":2,"n":"TimePlay","t":4,"rt":$n[0].Single,"sn":"TimePlay","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"endCard","t":4,"rt":$n[4].Button,"sn":"endCard"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"musicSource","t":4,"rt":$n[1].AudioSource,"sn":"musicSource"}]}; }, $n);
    /*LunaController end.*/

    /*TutController start.*/
    $m("TutController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"fromScale","t":4,"rt":$n[0].Single,"sn":"fromScale","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"moveTime","t":4,"rt":$n[0].Single,"sn":"moveTime","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"optionL","t":4,"rt":$n[1].RectTransform,"sn":"optionL"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"optionR","t":4,"rt":$n[1].RectTransform,"sn":"optionR"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"posL","t":4,"rt":$n[1].Vector3,"sn":"posL"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"posR","t":4,"rt":$n[1].Vector3,"sn":"posR"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"scaleTime","t":4,"rt":$n[0].Single,"sn":"scaleTime","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"sequence","t":4,"rt":$n[5].Sequence,"sn":"sequence"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"toScale","t":4,"rt":$n[0].Single,"sn":"toScale","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*TutController end.*/
