...
Deserializers["UnityEngine.UI.Image"] = function (request, data, root) {
  var i318 = root || request.c( 'UnityEngine.UI.Image' )
  var i319 = data
  request.r(i319[0], i319[1], 0, i318, 'm_Sprite')
  i318.m_Type = i319[2]
  i318.m_PreserveAspect = !!i319[3]
  i318.m_FillCenter = !!i319[4]
  i318.m_FillMethod = i319[5]
  i318.m_FillAmount = i319[6]
  i318.m_FillClockwise = !!i319[7]
  i318.m_FillOrigin = i319[8]
  i318.m_UseSpriteMesh = !!i319[9]
  i318.m_PixelsPerUnitMultiplier = i319[10]
  request.r(i319[11], i319[12], 0, i318, 'm_Material')
  i318.m_Maskable = !!i319[13]
  i318.m_Color = new pc.Color(i319[14], i319[15], i319[16], i319[17])
  i318.m_RaycastTarget = !!i319[18]
  i318.m_RaycastPadding = new pc.Vec4( i319[19], i319[20], i319[21], i319[22] )
  return i318
}

Deserializers["UnityEngine.UI.AspectRatioFitter"] = function (request, data, root) {
  var i320 = root || request.c( 'UnityEngine.UI.AspectRatioFitter' )
  var i321 = data
  i320.m_AspectMode = i321[0]
  i320.m_AspectRatio = i321[1]
  return i320
}
...
Deserializers["UnityEngine.UI.RawImage"] = function (request, data, root) {
  var i338 = root || request.c( 'UnityEngine.UI.RawImage' )
  var i339 = data
  request.r(i339[0], i339[1], 0, i338, 'm_Texture')
  i338.m_UVRect = UnityEngine.Rect.MinMaxRect(i339[2], i339[3], i339[4], i339[5])
  request.r(i339[6], i339[7], 0, i338, 'm_Material')
  i338.m_Maskable = !!i339[8]
  i338.m_Color = new pc.Color(i339[9], i339[10], i339[11], i339[12])
  i338.m_RaycastTarget = !!i339[13]
  i338.m_RaycastPadding = new pc.Vec4( i339[14], i339[15], i339[16], i339[17] )
  return i338
}

Deserializers["TutController"] = function (request, data, root) {
  var i340 = root || request.c( 'TutController' )
  var i341 = data
  request.r(i341[0], i341[1], 0, i340, 'leftCard')
  request.r(i341[2], i341[3], 0, i340, 'rightCard')
  i340.leftPos = new pc.Vec2( i341[4], i341[5] )
  i340.rightPos = new pc.Vec2( i341[6], i341[7] )
  request.r(i341[8], i341[9], 0, i340, 'tut')
  i340.timeMove = i341[10]
  i340.timeDelay = i341[11]
  return i340
}

Deserializers["UnityEngine.UI.Mask"] = function (request, data, root) {
  var i342 = root || request.c( 'UnityEngine.UI.Mask' )
  var i343 = data
  i342.m_ShowMaskGraphic = !!i343[0]
  return i342
}
...
Deserializers["LunaController"] = function (request, data, root) {
  ...
  i358.UsePixelArt = !!i359[2]
  request.r(i359[3], i359[4], 0, i358, 'BGM')
  request.r(i359[5], i359[6], 0, i358, 'normalLeft')
  request.r(i359[7], i359[8], 0, i358, 'pixelLeft')
  request.r(i359[9], i359[10], 0, i358, 'normalRight')
  request.r(i359[11], i359[12], 0, i358, 'pixelRight')
  request.r(i359[13], i359[14], 0, i358, 'musicSource')
  request.r(i359[15], i359[16], 0, i358, 'endCard')
  return i358
}
...
Deserializers.buildID = "c5e1afd4-1eca-4a0d-85a0-84247897cb11";
