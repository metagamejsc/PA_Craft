...
namespace Playable
{
    ...
    public class Monster : MonoBehaviour
    {
        ...
        [Tooltip("Bật: monster đứng yên hoàn toàn tại vị trí spawn, không wander, không chase, không đánh và không dùng skill. Monster khác vẫn có thể chọn nó làm mục tiêu.")]
        [SerializeField]
        private bool _stayStillOnSpawn;
        ...
        {
            if (!_hasAnimator || _animator.gameObject.GetComponent<MonsterAnimationEvents>() != null)
            {
                return;
            }
            ...
            {
                case MonsterType.Enderman:
                    _animator.gameObject.AddComponent<EndermanAnimationEvents>();
                    break;

                case MonsterType.IronGolem:
                    _animator.gameObject.AddComponent<IronGolemAnimationEvents>();
                    break;

                case MonsterType.Creeper:
                    _animator.gameObject.AddComponent<CreeperAnimationEvents>();
                    break;

                case MonsterType.Huggy:
                    _animator.gameObject.AddComponent<HuggyAnimationEvents>();
                    break;

                case MonsterType.Shinsonic:
                    _animator.gameObject.AddComponent<ShinsonicAnimationEvents>();
                    break;
            }
        }
        ...
        private void PlayDeathVfx()
        {
            ...
            _deathVfxPrefab.gameObject.SetActive(true);
