...
half3 BlendNormals(half3 n1, half3 n2) {
    ...
    #define VOXELPLAY_LIGHT_ATTENUATION(i) saturate(i.light.x + _MainLightPosition.y * _VPDaylightShadowAtten * i.light.z)
    ...
    #endif
    #define VOXELPLAY_LIGHT_ATTENUATION(i) saturate(VOXELPLAY_SHADOW_ATTENUATION(i) * i.light.x + _MainLightPosition.y * _VPDaylightShadowAtten * i.light.z)
