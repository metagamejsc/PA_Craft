...
public class ProjectileController : MonoBehaviour
{
    ...
    void HandleHit(RaycastHit hit)
    {
        ...
        if (shouldSpawnHitEffect)
        {
            ...
            DestroySpawnedHitEffect(GetSpawnedEffectGameObject(effectInstance));
        }
    ...
    GameObject GetSpawnedEffectGameObject(UnityEngine.Object effectInstance)
    {
        if (effectInstance is GameObject effectGameObject)
        {
            return effectGameObject;
        }

        if (effectInstance is Component effectComponent)
        {
            return effectComponent.gameObject;
        }
