...
public class TilePos
{
    ...
    public static Dictionary<Tile, TilePos> tiles = new Dictionary<Tile, TilePos>()
    {
        ...
        {Tile.PlankBrich, new TilePos(0,7)},
        {Tile.Brick, new TilePos(0,8)},
        {Tile.Glass, new TilePos(0,9)},
        {Tile.Empty, new TilePos(0,10)},
    };
}

public enum Tile {Dirt, Grass, GrassSide, Stone, TreeSide, TreeCX, Leaves,Iron, PlankBrich, Brick, Glass,TNT, Empty}
