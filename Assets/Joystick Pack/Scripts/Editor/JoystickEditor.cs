...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty simulateLunaInput;
    private SerializedProperty inputBlockers;
    ...
    protected virtual void OnEnable()
    {
        ...
        simulateLunaInput = serializedObject.FindProperty("simulateLunaInput");
        inputBlockers = serializedObject.FindProperty("inputBlockers");
    }
    ...
    protected virtual void DrawComponents()
    {
        ...
        EditorGUILayout.PropertyField(simulateLunaInput);
        EditorGUILayout.PropertyField(inputBlockers, true);
    }
}
